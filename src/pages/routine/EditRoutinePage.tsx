...
import { useRoutineById, useEditRoutine } from '@/hooks/useRoutines'
...
export function EditRoutinePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await editRoutine.mutateAsync({ id: routineId, data })
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold">{t('editRoutine')}</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-4">
          <Button
            ...
            disabled={editRoutine.isPending}
          >
            {tCommon('actions.cancel')}
          </Button>
          <Button type="submit" className="flex-1" disabled={editRoutine.isPending}>
            {editRoutine.isPending ? (
              <>
